...
<main class="md:flex items-start mx-auto justify-center px-8">
	<section class="max-w-prose sm:mr-12">
...
<section id="security-note" class="text-sm text-slate-500 mt-12 text-center">
	<p class="mb-2">
